...
//        resolver.setDefaultLocale(Locale.ENGLISH); // Set default locale
	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
		http.authorizeHttpRequests(requests -> requests.requestMatchers(new AntPathRequestMatcher("/"),
				new AntPathRequestMatcher("/css/**"), new AntPathRequestMatcher("/qr-code/**"),
				new AntPathRequestMatcher("/images/**"), new AntPathRequestMatcher("/webjars/**"),
				new AntPathRequestMatcher("/js/**"), new AntPathRequestMatcher("/fragment/**"),
				new AntPathRequestMatcher("/connection/**"), new AntPathRequestMatcher("/c/**"),
				new AntPathRequestMatcher("/console/**"), new AntPathRequestMatcher("/r-login"),
				new AntPathRequestMatcher("/exit"), new AntPathRequestMatcher("/u/**"),
				new AntPathRequestMatcher("/update/**"), new AntPathRequestMatcher("/modal/**"), new AntPathRequestMatcher("/file/**"),
				new AntPathRequestMatcher("/upgrade/**"), new AntPathRequestMatcher("/serial/**")).permitAll()
	...
	public UserDetailsService userDetailsService() {
		...
		UserDetails user = users.username("user").password(p).roles("USER").build();
		UserDetails admin = users.username("admin").password(p2).roles("USER", "ADMIN").build();
