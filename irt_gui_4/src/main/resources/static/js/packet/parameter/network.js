...
network.buc[1].parser = bytes=>parseToIrtValue({ bytes, divider: 10, postfix: ' dBm', measurementType: 'power' });
network.buc[2] = {}
network.buc.outputPower				 = 2;
network.buc[2].description = 'Output Power';
network.buc[2].parser =  bytes=>parseToIrtValue({ bytes, divider: 10,  postfix: ' dBm',  measurementType: 'power' });
network.buc[3] = {}
network.buc.unitTemperature			 = 3;
network.buc[3].description = 'Temperature';
network.buc[3].parser = bytes=>parseToIrtValue({ bytes, divider: 10,  postfix: ' °C',  measurementType: 'temperature' });
network.buc[4] = {}
