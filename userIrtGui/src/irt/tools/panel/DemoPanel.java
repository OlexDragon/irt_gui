...
public class DemoPanel extends Panel {
	...
	public DemoPanel() {
		...
		panel.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Monitor", TitledBorder.LEADING, TitledBorder.TOP, new Font("Tahoma", Font.PLAIN, 14), Color.WHITE));
		...
		Font font = replaceFont("resource.font", "mute_label_font_size", FONT, _18);
		...
		panel_1.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Control", TitledBorder.LEADING, TitledBorder.TOP, new Font("Tahoma", Font.PLAIN, 14), Color.WHITE));
		...
		ImageButton imageButton_1 = new ImageButton(new ImageIcon(IrtGui.class.getResource("/irt/irt_gui/images/whitehouse_button.png")).getImage());
		imageButton_1.setToolTipText("Store Config");
		imageButton_1.setShadowShiftY(4);
		imageButton_1.setShadowShiftX(4);
		imageButton_1.setShadowPressedShiftY(1);
		imageButton_1.setShadowPressedShiftX(1);
		imageButton_1.setName("Store");
		imageButton_1.setBounds(162, 104, 33, 33);
		panel_1.add(imageButton_1);
		...
		JCheckBox checkBox = new JCheckBox("Step:");
		checkBox.setEnabled(false);
		checkBox.setOpaque(false);
		checkBox.setForeground(Color.WHITE);
		checkBox.setFont(new Font("Tahoma", Font.PLAIN, 12));
		checkBox.setBounds(13, 68, 55, 23);
		...
		InfoPanel infoPanel = new InfoPanel((LinkHeader) null);
	...
	public void refresh() {
		...
		Font font = replaceFont("resource.font", "mute_label_font_size", FONT, MUTE_LABEL_FONT_SIZE);
		lblMute.setFont(font);
