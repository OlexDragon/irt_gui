...
public class StoreConfigController extends ControllerAbstract {
	...
	public StoreConfigController(LinkHeader linkHeader, Component owner, Style style) {
		super(new Setter(linkHeader, Packet.IRT_SLCP_PACKET_ID_CONFIG_PROFILE, Packet.IRT_SLCP_PACKET_ID_CONFIG_PROFILE_SAVE, PacketWork.PACKET_ID_STORE_CONFIG), style);
		setSend(false);
