...
public interface PacketWork extends Comparable<PacketWork>{
	...
	public static final short 	PACKET_ID_DEVICE_DEBUG			 		= 1147,
								...
								//CONTROL GROUP
								PACKET_ID_ACTIVE_MODULE 			= PACKET_ID_DEVICE_DEBUG_ADDR_100 + 255,
								PACKET_ID_MODULE_LIST 				= PACKET_ID_ACTIVE_MODULE + 1,

								//Redundancy Group
								PACKET_ID_REDUNDANCY_CONTROLLER_STATUS = PACKET_ID_ACTIVE_MODULE + 255,
								PACKET_ID_SWITCHOVER_MODE			= PACKET_ID_ACTIVE_MODULE + 1,
								PACKET_ID_SWITCHOVER				= PACKET_ID_ACTIVE_MODULE + 2,
								PACKET_ID_STANDBY_MODE				= PACKET_ID_ACTIVE_MODULE + 3;

	//Dumps to file
		public static final short	DUMPS										= PACKET_ID_REDUNDANCY_CONTROLLER_STATUS + 255,	// Start of dump indexes
		...
		public enum PacketIDs{
			...
			CONTROL_ACTIVE_MODULE(PACKET_ID_ACTIVE_MODULE),
			CONTRO_MODULE_LIST(PACKET_ID_MODULE_LIST),
			...
			REDUNDANCY_CONTROLLER_STATUS	(PACKET_ID_REDUNDANCY_CONTROLLER_STATUS),
			REDUNDANCY_SWITCHOVER_MOD		(PACKET_ID_SWITCHOVER_MODE),
			REDUNDANCY_STANDBY_MODE		(PACKET_ID_STANDBY_MODE),
