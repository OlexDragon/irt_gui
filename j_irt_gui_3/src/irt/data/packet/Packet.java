...
public class Packet {
	...
	/* Measurement codes. */
	public static final byte
			IRT_SLCP_PARAMETER_MEASUREMENT_PICOBUC_INPUT_POWER	= 1,
			IRT_SLCP_PARAMETER_MEASUREMENT_PICOBUC_OUTPUT_POWER	= 2,
			IRT_SLCP_PARAMETER_MEASUREMENT_PICOBUC_TEMPERATURE	= 3,
			IRT_SLCP_PARAMETER_MEASUREMENT_PICOBUC_STATUS		= 4,
