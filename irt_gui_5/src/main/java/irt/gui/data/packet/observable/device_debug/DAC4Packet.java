...
public class DAC4Packet extends RegisterPacket{

	private static final int BUC_ADDR = 4;
	private static final int BUC_INDEX = 100;
	private static final int FCM_ADDR = 0;
	private static final int FCM_INDEX = 4;

	public DAC4Packet(byte[] answer, Boolean hasAcknowledgment) throws PacketParsingException {
		super(answer, hasAcknowledgment);
	}

	public DAC4Packet(Integer value) throws PacketParsingException {
		super("DAC4Packet", new RegisterValue(BUC_INDEX, BUC_ADDR, value));
	}
