...
public class Dac10MHzRangePacket extends PacketAbstract5 implements RangePacket{

	public static final PacketId PACKET_ID = PacketId.CONFIGURATION_10MHZ_DAC_RANGE;

	public Dac10MHzRangePacket() throws PacketParsingException {
		super(
				new PacketHeader(
						PacketType.REQUEST,
						new PacketIdDetails(
	...
	public Dac10MHzRangePacket(@JsonProperty("asBytes") byte[] answer, @JsonProperty(defaultValue="false", value="v") Boolean hasAcknowledgment) throws PacketParsingException {
