...
public class Packet {
	...
	public static final byte PARAMETER_PICOBUC_CONFIGURATION_LO_SET 				= 1,
							PARAMETER_PICOBUC_CONFIGURATION_MUTE 					= 2,
							PARAMETER_PICOBUC_CONFIGURATION_GAIN 					= 3,
							PARAMETER_PICOBUC_CONFIGURATION_ATTENUATION 			= 4,
							PARAMETER_PICOBUC_CONFIGURATION_GAIN_RANGE 				= 5,
							PARAMETER_PICOBUC_CONFIGURATION_LO_FREQUENCIES			= 7,
							PARAMETER_PICOBUC_CONFIGURATION_USER_FREQUENCY 			= 8,
							PARAMETER_PICOBUC_CONFIGURATION_USER_FREQUENCY_RANGE 	= 9,
