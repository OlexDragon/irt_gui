...
public class Packet {
	...
	public static final byte
		...
		PARAMETER_MEASUREMENT_STATUS_10MHZ_REF		= 13,
		...
		PARAMETER_MEASUREMENT_TEMPERATURE_PCS		= PARAMETER_MEASUREMENT_FCM_TEMPERATURE_CPU,
		PARAMETER_MEASUREMENT_TEMPERATURE_MCU		= 11,
		PARAMETER_MEASUREMENT_REFERENCE_LEVEL		= 12,
	...
	public static final byte PARAMETER_CONFIG_LO_SET 								= 1,
							PARAMETER_SAVE_CONFIG									= PARAMETER_CONFIG_LO_SET,
							...
							PARAMETER_CONFIG_REDUNDANCY_ENABLE						= 10,
							PARAMETER_CONFIG_REDUNDANCY_MODE						= 11,
							PARAMETER_CONFIG_REDUNDANCY_NAME						= 12,
							PARAMETER_CONFIG_REDUNDANCY_STAT						= 15,
							PARAMETER_CONFIG_REDUNDANCY_SET_ONLINE					= 14,

							PARAMETER_CONFIG_10MHZ_REFCLOCK_SOURCE					= PARAMETER_CONFIG_LO_SET,
							PARAMETER_CONFIG_10MHZ_DAC_RANGE						= PARAMETER_CONFIG_MUTE,
							PARAMETER_CONFIG_10MHZ_DAC								= PARAMETER_CONFIG_GAIN;
