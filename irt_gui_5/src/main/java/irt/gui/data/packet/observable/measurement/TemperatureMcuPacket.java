...
public class TemperatureMcuPacket extends PacketAbstract5 implements ValuePacket{

	public static final PacketId PACKET_ID = PacketId.MEASUREMENT_TEMPERATURE_MCU;

	public TemperatureMcuPacket() throws PacketParsingException {
		super(
				new PacketHeader(
						PacketType.REQUEST,
	...
	public TemperatureMcuPacket(@JsonProperty("asBytes") byte[] answer, @JsonProperty(defaultValue="false", value="v") Boolean hasAcknowledgment) throws PacketParsingException {
