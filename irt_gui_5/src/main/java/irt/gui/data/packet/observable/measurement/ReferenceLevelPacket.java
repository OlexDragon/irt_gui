...
public class ReferenceLevelPacket extends PacketAbstract5 implements ValuePacket{

	public static final PacketId PACKET_ID = PacketId.MEASUREMENT_REFERENCE_LEVEL;

	public ReferenceLevelPacket() throws PacketParsingException {
		super(
				new PacketHeader(
						PacketType.REQUEST,
	...
	public ReferenceLevelPacket(@JsonProperty("asBytes") byte[] answer, @JsonProperty(defaultValue="false", value="v") Boolean hasAcknowledgment) throws PacketParsingException {
