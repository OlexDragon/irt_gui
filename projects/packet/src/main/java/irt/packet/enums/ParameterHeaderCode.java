...
public enum ParameterHeaderCode {
	...
	//Measurement
	M_TEMPERATURE_UNIT		(Packet.PARAMETER_MEASUREMENT_TEMPERATURE		, PacketGroupId.MEASUREMENT ),
	M_TEMPERATURE_CPU		(Packet.PARAMETER_MEASUREMENT_FCM_TEMPERATURE_CPU, PacketGroupId.MEASUREMENT ),
	...
	M_OUTPUT_POWER_BUC		(Packet.PARAMETER_MEASUREMENT_OUTPUT_POWER		, PacketGroupId.MEASUREMENT ),
	M_OUTPUT_POWER_FCM		(Packet.PARAMETER_MEASUREMENT_FCM_OUTPUT_POWER	, PacketGroupId.MEASUREMENT ),
	M_STATUS_BUC			(Packet.PARAMETER_MEASUREMENT_STATUS_BUC		, PacketGroupId.MEASUREMENT ),
	M_STATUS_FCM			(Packet.PARAMETER_MEASUREMENT_FCM_STATUS		, PacketGroupId.MEASUREMENT ),
	M_5_5V					(Packet.PARAMETER_MEASUREMENT_FCM_MON_5V5		, PacketGroupId.MEASUREMENT ),
	M_13_2V					(Packet.PARAMETER_MEASUREMENT_FCM_MON_13V2_POS	, PacketGroupId.MEASUREMENT ),
	M_13_2V_NEG				(Packet.PARAMETER_MEASUREMENT_FCM_MON_13V2_NEG	, PacketGroupId.MEASUREMENT ),
	M_LNB_CURRENT			(Packet.PARAMETER_MEASUREMENT_FCM_CURRENT		, PacketGroupId.MEASUREMENT ),
	M_ATTENUATION			(Packet.PARAMETER_MEASUREMENT_FCM_ATTENUATION	, PacketGroupId.MEASUREMENT ),
	M_REFERENCE_SOURCE		(Packet.PARAMETER_MEASUREMENT_REFERENCE_SOURCE	, PacketGroupId.MEASUREMENT ),
	M_MEASUREMENT_ALL_FCM	(Packet.PARAMETER_MEASUREMENT_FCM_ALL			, PacketGroupId.MEASUREMENT ),
	M_MEASUREMENT_ALL_BUC	(Packet.PARAMETER_MEASUREMENT_BUC_ALL			, PacketGroupId.MEASUREMENT ),
	//Production
