...
public class AllMeasurementsPacket extends PacketAbstract implements ValuePacket{

	public static final PacketId PACKET_ID = PacketId.MEASUREMENT_ALL_BUC;
	public static final PacketId FCM_PACKET_ID = PacketId.MEASUREMENT_ALL_FCM;

	public AllMeasurementsPacket() {
		super(
				new PacketHeader(
						PacketType.REQUEST,
	...
	public AllMeasurementsPacket(@JsonProperty("asBytes") byte[] answer, @JsonProperty(defaultValue="false", value="v") Boolean hasAcknowledgment) throws PacketParsingException {
