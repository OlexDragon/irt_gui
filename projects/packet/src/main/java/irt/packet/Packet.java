...
public class Packet {
	...
	public static final byte
			...
			PARAMETER_MEASUREMENT_BUC_ALL = IRT_SLCP_PARAMETER_ALL; /* Read all available measurements. */
	...
	public static final byte
		...
		PARAMETER_MEASUREMENT_FCM_ATTENUATION		= 20,
		PARAMETER_MEASUREMENT_REFERENCE_SOURCE		= 21,
