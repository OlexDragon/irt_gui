...
public class TitledPaneMeasurementFxTest extends ApplicationTest {
	...
	private TitledPaneMeasurementFx measurementFx;
	...
	public void start(Stage stage) throws Exception {
		...
		try {
			...
			measurementFx = new TitledPaneMeasurementFx();
			measurementFx.setKey(PREFS_NAME);

			stage.setScene(new Scene(new VBox(comboBoxSerialPortFx, measurementFx)));
			stage.show();
